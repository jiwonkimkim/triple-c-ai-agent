...

{
  ...
  "sections": [
    {
      "type": "MAIN",
      "title": "제품 슬로건 (예: 국민세안제, 어워즈 1등 세럼, No.1 선크림)",
      "body": "수상/랭킹 정보와 프로모션을 짧게. 예: '5년 연속 올영어워즈 수상 | 올영픽 선정 | 본품+미니 기획'"
    },
    {
      "type": "HERO",
...
1. **MAIN 섹션** (메인 썸네일 이미지용 - 상품 리스트에서 보이는 제품 슬로건 이미지)
   - title: 제품 슬로건 또는 별명 - 강렬하고 기억에 남는 한마디
     예: "국민세안제", "어워즈 1등 세럼", "No.1 선크림", "5년 연속 수상"
   - body: 수상/랭킹 + 프로모션 정보를 | 로 구분하여 짧게
     예: "올영어워즈 5년 연속 | 올영픽 선정 | 본품+미니 기획"
   - 숫자 강조 (1등, 5년, 3개 등)
   - 텍스트는 최소화, 임팩트 최대화
