...
export const SECTION_STORY_GUIDE: Record<string, SectionStoryGuide> = {
  ...
  MAIN: {
    ...
    textEmphasis: ['제품 슬로건', '수상 이력', '랭킹 정보', '프로모션'],
    visualEmphasis: ['제품 패키지 크게 중심', '컬러풀 그라데이션 배경', '올영PICK/어워즈 배지', '증정품 구성', '축제 분위기'],
    textTone: '임팩트 있는 슬로건, 숫자 강조 (1등, 5년, 3개)',
    bestPractices: [
      '제품 패키지가 크게 중앙에 떠있는 느낌으로',
      '컬러풀한 그라데이션 배경 (블루-핑크, 그린-옐로)',
      '올영PICK, 어워즈 배지, 랭킹 메달 등 코너에',
      '증정품/기획 세트 함께 표시',
      '반짝이/컨페티 효과로 축제 분위기',
      '"국민세안제", "어워즈 1등" 같은 강렬한 슬로건',
    ],
    copyGuide: {
      headline: '제품 슬로건 또는 별명 (예: "국민세안제", "어워즈 1등 세럼")',
      subheadline: '수상/랭킹 정보 (예: "5년 연속 수상", "올영픽 선정")',
    },
  },
  HERO: {
    position: 'intro',
