...
import { SD35_CONFIG } from './config';
import { buildSD35Negative } from './negative';

// ============================================
// SD 3.5 프롬프트 빌더
// ============================================

export const sd35Builder: ModelPromptBuilder = {
  config: SD35_CONFIG,
  ...
  buildPrompt(input: PromptInput): PromptOutput {
    ...
    const negative = buildSD35Negative({
